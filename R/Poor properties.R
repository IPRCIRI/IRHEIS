...
##### Age #####
#Calculation
Age<-CBN95[,Age:=weighted.mean(HAge,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
#sm.density.compare(CBN95$HAge, CBN95$Poor11)
...
##### Sex #####
Female<-CBN_Poor95[,Female_Poors:=weighted.mean(ifelse(HSex %in% "Female",1,0),Weight),by=ProvinceCode][order(ProvinceCode)]
...
Female<-CBN95[,Female:=weighted.mean(ifelse(HSex %in% "Female",1,0),Weight),by=ProvinceCode][order(ProvinceCode)]
...
##### Size #####
Size<-CBN95[,Size:=weighted.mean(Size,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
#sm.density.compare(CBN95$Size, CBN95$Poor11)
#sm.density.compare(CBN_Poor95$Size, CBN_Poor95$cluster)


##### Literature #####
Literate<-CBN_Poor95[,Literate_Poors:=weighted.mean(ifelse(HLiterate %in% "TRUE",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Literate<-CBN95[,Literate:=weighted.mean(ifelse(HLiterate %in% "TRUE",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
#Education<-CBN95[,Education_Poors1:=weighted.mean(ifelse(HEduLevel0 %in% "Illiterate",1,
...
Education<-CBN95[,Education_Poors1:=weighted.mean(ifelse(HEduLevel0 %in% "Illiterate",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN95[,Education_Poors2:=weighted.mean(ifelse(HEduLevel0 %in% "Elementary",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN95[,Education_Poors3:=weighted.mean(ifelse(HEduLevel0 %in% "Middle",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN95[,Education_Poors4:=weighted.mean(ifelse(HEduLevel0 %in% "High",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN95[,Education_Poors5:=weighted.mean(ifelse(HEduLevel0 %in% "Pre",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN95[,Education_Poors6:=weighted.mean(ifelse(HEduLevel0 %in% "University",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
##### Activity #####
Activity<-CBN95[,Activity_Poors1:=weighted.mean(ifelse(HActivityState %in% "Employed",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN95[,Activity_Poors2:=weighted.mean(ifelse(HActivityState %in% "Unemployed",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN95[,Activity_Poors3:=weighted.mean(ifelse(HActivityState %in% "Income without Work",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN95[,Activity_Poors4:=weighted.mean(ifelse(HActivityState %in% "Student",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN95[,Activity_Poors5:=weighted.mean(ifelse(HActivityState %in% "Housekeeper",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN95[,Activity_Poors6:=weighted.mean(ifelse(HActivityState %in% "Other",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
