...
###############Urban###############
#####Cluster 1
a<-MDH[Region=="Urban" & NewArea==30,.(Engel,cluster2,NewArea2)]
b<-MDH[Region=="Urban" & NewArea!=30 & cluster2==1,.(Engel,cluster2,NewArea2)]
t.test(a$Engel,b$Engel, var.equal=TRUE, paired=FALSE)

#####Cluster 2
a<-MDH[Region=="Urban" & NewArea==2,.(Engel,cluster2,NewArea2)]
b<-MDH[Region=="Urban" & NewArea!=2 & cluster2==2,.(Engel,cluster2,NewArea2)]
t.test(a$Engel,b$Engel, var.equal=TRUE, paired=FALSE)

#####Cluster 3
a<-MDH[Region=="Urban" & NewArea==18,.(Engel,cluster2,NewArea2)]
b<-MDH[Region=="Urban" & NewArea!=18 & cluster2==3,.(Engel,cluster2,NewArea2)]
t.test(a$Engel,b$Engel, var.equal=TRUE, paired=FALSE)

#####Cluster 4
a<-MDH[Region=="Urban" & NewArea==12,.(Engel,cluster2,NewArea2)]
b<-MDH[Region=="Urban" & NewArea!=12 & cluster2==4,.(Engel,cluster2,NewArea2)]
t.test(a$Engel,b$Engel, var.equal=TRUE, paired=FALSE)

#####Cluster 5
a<-MDH[Region=="Urban" & NewArea==8,.(Engel,cluster2,NewArea2)]
b<-MDH[Region=="Urban" & NewArea!=8 & cluster2==5,.(Engel,cluster2,NewArea2)]
t.test(a$Engel,b$Engel, var.equal=TRUE, paired=FALSE)
