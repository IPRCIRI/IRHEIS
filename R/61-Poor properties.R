...
##### Age #####
#Calculation
Age<-CBN_NonPoor95[,Age:=weighted.mean(HAge,Weight),by=ProvinceCode2][order(ProvinceCode2)]
Age<-Age[,.(Age,ProvinceCode2,Weight)]
Age1<-Age[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(ProvinceCode2)]
Age1[,Weight:=NULL]

Age<-CBN_Poor95[,Poor_Age:=weighted.mean(HAge,Weight),by=ProvinceCode2][order(ProvinceCode2)]
Age<-Age[,.(Poor_Age,ProvinceCode2,Weight)]
Age2<-Age[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(ProvinceCode2)]

Age<-CBN_NonPoor95[,Poor_Age_40:=weighted.mean(ifelse(HAge<=40,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
Age<-Age[,.(Poor_Age_40,ProvinceCode2,Weight)]
Age3<-Age[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(ProvinceCode2)]

Age<-CBN_NonPoor95[,Poor_Age_4050:=weighted.mean(ifelse(HAge>40 & HAge<50,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
Age<-Age[,.(Poor_Age_4050,ProvinceCode2,Weight)]
Age4<-Age[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(ProvinceCode2)]

Age<-CBN_NonPoor95[,Poor_Age_50:=weighted.mean(ifelse(HAge>=50,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Age<-CBN_Poor95[,Poor_Age_40:=weighted.mean(ifelse(HAge<=40,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
Age<-Age[,.(Poor_Age_40,ProvinceCode2,Weight)]
Age6<-Age[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(ProvinceCode2)]

Age<-CBN_Poor95[,Poor_Age_4050:=weighted.mean(ifelse(HAge>40 & HAge<50,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
Age<-Age[,.(Poor_Age_4050,ProvinceCode2,Weight)]
Age7<-Age[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(ProvinceCode2)]

Age<-CBN_Poor95[,Poor_Age_50:=weighted.mean(ifelse(HAge>=50,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
Age<-Age[,.(Poor_Age_50,ProvinceCode2,Weight)]
...
Age<-CBN95[,Age_40:=weighted.mean(ifelse(HAge<=40,1,0),Weight),by=Poor11][order(Poor11)]
Age<-Age[,.(Age_40,Poor11,Weight)]
Age6<-Age[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(Poor11)]
Age6[,Weight:=NULL]

Age<-CBN95[,Age_4050:=weighted.mean(ifelse(HAge>40 & HAge<50,1,0),Weight),by=Poor11][order(Poor11)]
Age<-Age[,.(Age_4050,Poor11,Weight)]
Age7<-Age[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(Poor11)]

Age<-CBN95[,Age_50:=weighted.mean(ifelse(HAge>=50,1,0),Weight),by=Poor11][order(Poor11)]
...
#sm.density.compare(CBNPoor_Urban$HAge, CBNPoor_Urban$cluster)

#sm.density.compare(CBN_Rural$HAge, CBN_Rural$Poor11)
#sm.density.compare(CBNPoor_Rural$HAge, CBNPoor_Rural$cluster)

#sm.density.compare(CBN_NonPoor95$HAge, CBN_NonPoor95$Poor11)
#sm.density.compare(CBN_Poor95$HAge, CBN_Poor95$cluster)
...
Female<-CBN95[,Female:=weighted.mean(ifelse(HSex %in% "Female",1,0),Weight),by=Poor11][order(Poor11)]
...
##### Size #####
Size<-CBN_NonPoor95[,Size:=weighted.mean(Size,Weight),by=ProvinceCode2][order(ProvinceCode2)]
Size<-Size[,.(Size,ProvinceCode2,Weight)]
Size1<-Size[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(ProvinceCode2)]
Size1[,Weight:=NULL]

Size<-CBN_Poor95[,Poor_Size:=weighted.mean(Size,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Size<-CBN95[,Size:=weighted.mean(Size,Weight),by=Poor11][order(Poor11)]
...
#sm.density.compare(CBNPoor_Urban$Size, CBNPoor_Urban$cluster)

#sm.density.compare(CBN_Rural$Size, CBN_Rural$Poor11)
#sm.density.compare(CBNPoor_Rural$Size, CBNPoor_Rural$cluster)

#sm.density.compare(CBN_NonPoor95$Size, CBN_NonPoor95$Poor11)
#sm.density.compare(CBN_Poor95$Size, CBN_Poor95$cluster)


##### Literature #####
Literate<-CBN_NonPoor95[,Literate_Poors:=weighted.mean(ifelse(HLiterate %in% "TRUE",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Literate<-CBN_Poor95[,Literate:=weighted.mean(ifelse(HLiterate %in% "TRUE",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Literate<-CBN95[,Literate:=weighted.mean(ifelse(HLiterate %in% "TRUE",1,0),Weight),by=Poor11][order(Poor11)]
...
Education<-CBN_NonPoor95[,Education_Poors1:=weighted.mean(ifelse(HEduLevel0 %in% "Illiterate",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN_NonPoor95[,Education_Poors2:=weighted.mean(ifelse(HEduLevel0 %in% "Elementary",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN_NonPoor95[,Education_Poors3:=weighted.mean(ifelse(HEduLevel0 %in% "Middle",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN_NonPoor95[,Education_Poors4:=weighted.mean(ifelse(HEduLevel0 %in% "High",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN_NonPoor95[,Education_Poors5:=weighted.mean(ifelse(HEduLevel0 %in% "Pre",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN_NonPoor95[,Education_Poors6:=weighted.mean(ifelse(HEduLevel0 %in% "University",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN_Poor95[,Education_Poors7:=weighted.mean(ifelse(HEduLevel0 %in% "Illiterate",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN_Poor95[,Education_Poors8:=weighted.mean(ifelse(HEduLevel0 %in% "Elementary",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN_Poor95[,Education_Poors9:=weighted.mean(ifelse(HEduLevel0 %in% "Middle",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN_Poor95[,Education_Poors10:=weighted.mean(ifelse(HEduLevel0 %in% "High",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN_Poor95[,Education_Poors11:=weighted.mean(ifelse(HEduLevel0 %in% "Pre",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN_Poor95[,Education_Poors12:=weighted.mean(ifelse(HEduLevel0 %in% "University",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education13<-CBN95[,Education1:=weighted.mean(ifelse(HEduLevel0 %in% "Illiterate",1,0),Weight),by=Poor11][order(Poor11)]
...
Education14<-CBN95[,Education2:=weighted.mean(ifelse(HEduLevel0 %in% "Elementary",1,0),Weight),by=Poor11][order(Poor11)]
...
Education15<-CBN95[,Education3:=weighted.mean(ifelse(HEduLevel0 %in% "Middle",1,0),Weight),by=Poor11][order(Poor11)]
...
Education16<-CBN95[,Education4:=weighted.mean(ifelse(HEduLevel0 %in% "High",1,0),Weight),by=Poor11][order(Poor11)]
...
Education17<-CBN95[,Education5:=weighted.mean(ifelse(HEduLevel0 %in% "Pre",1,0),Weight),by=Poor11][order(Poor11)]
...
Education18<-CBN95[,Education6:=weighted.mean(ifelse(HEduLevel0 %in% "University",1,0),Weight),by=Poor11][order(Poor11)]
...
##### Activity #####
Activity<-CBN_NonPoor95[,Activity_Poors1:=weighted.mean(ifelse(HActivityState %in% "Employed",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN_NonPoor95[,Activity_Poors2:=weighted.mean(ifelse(HActivityState %in% "Unemployed",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN_NonPoor95[,Activity_Poors3:=weighted.mean(ifelse(HActivityState %in% "Income without Work",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN_NonPoor95[,Activity_Poors4:=weighted.mean(ifelse(HActivityState %in% "Student",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN_NonPoor95[,Activity_Poors5:=weighted.mean(ifelse(HActivityState %in% "Housekeeper",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN_NonPoor95[,Activity_Poors6:=weighted.mean(ifelse(HActivityState %in% "Other",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN_Poor95[,Activity_Poors7:=weighted.mean(ifelse(HActivityState %in% "Employed",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN_Poor95[,Activity_Poors8:=weighted.mean(ifelse(HActivityState %in% "Unemployed",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN_Poor95[,Activity_Poors9:=weighted.mean(ifelse(HActivityState %in% "Income without Work",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN_Poor95[,Activity_Poors10:=weighted.mean(ifelse(HActivityState %in% "Student",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN_Poor95[,Activity_Poors11:=weighted.mean(ifelse(HActivityState %in% "Housekeeper",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN_Poor95[,Activity_Poors12:=weighted.mean(ifelse(HActivityState %in% "Other",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity13<-CBN95[,Activity1:=weighted.mean(ifelse(HActivityState %in% "Employed",1,0),Weight),by=Poor11][order(Poor11)]
...
Activity14<-CBN95[,Activity2:=weighted.mean(ifelse(HActivityState %in% "Unemployed",1,0),Weight),by=Poor11][order(Poor11)]
...
Activity15<-CBN95[,Activity3:=weighted.mean(ifelse(HActivityState %in% "Income without Work",1,0),Weight),by=Poor11][order(Poor11)]
...
Activity16<-CBN95[,Activity4:=weighted.mean(ifelse(HActivityState %in% "Student",1,0),Weight),by=Poor11][order(Poor11)]
...
Activity17<-CBN95[,Activity5:=weighted.mean(ifelse(HActivityState %in% "Housekeeper",1,0),Weight),by=Poor11][order(Poor11)]
...
Activity18<-CBN95[,Activity6:=weighted.mean(ifelse(HActivityState %in% "Other",1,0),Weight),by=Poor11][order(Poor11)]
