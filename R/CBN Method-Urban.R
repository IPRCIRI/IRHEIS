...
CBN$Ghand_W<-CBN$Ghandgram*CBN$GhandPrice
CBN$Hoboobat_W<-CBN$Hoboobatgram*CBN$HoboobatPrice
CBN$Roghan_W<-CBN$Roghangram*CBN$RoghanPrice
CBN$Berenj_W<-CBN$Berenjgram*CBN$BerenjPrice
CBN$Nan_W<-CBN$Nangram*CBN$NanPrice
CBN$Goosht_W<-CBN$Gooshtgram*CBN$GooshtPrice
CBN$Morgh_W<-CBN$Morghgram*CBN$MorghPrice
CBN$Mahi_W<-CBN$Mahigram*CBN$MahiPrice
CBN$Shir_W<-CBN$Shirgram*CBN$ShirPrice
CBN$Mast_W<-CBN$Mastgram*CBN$MastPrice
CBN$Panir_W<-CBN$Panirgram*CBN$PanirPrice
CBN$Tokhmemorgh_W<-CBN$Tokhmemorghgram*CBN$TokhmemorghPrice
CBN$Mive_W<-CBN$Mivegram*CBN$MivePrice
CBN$Sabzi_W<-CBN$Sabzigram*CBN$SabziPrice
CBN$Makarooni_W<-CBN$Makaroonigram*CBN$MakarooniPrice
CBN$Sibzamini_W<-CBN$Sibzaminigram*CBN$SibzaminiPrice
CBN$Home_W<-CBN$ServiceExp
...
cclust::cclust(dt,5, dist = "euclidean", method = "kmeans")
#cl <-ewkm(PRICE, 5, lambda=1, maxiter=1000, delta=0.00001, maxrestart=10)
## Creating state sequence object
mvad.seq <- seqdef(mvad[aggMvad$aggIndex, 17:86], weights=aggMvad$aggWeights)
## Computing Hamming distance between sequence
diss <- seqdist(mvad.seq, method="HAM")

clust5 <- wcKMedoids(dt, k=5, weights=PRICE)
