...
t1 <-TotalDurable[as.numeric(Decile)==1, {lapply(.SD, function(x) sum(x*Weight)/sum(Weight))}][]
t2 <-TotalDurable[as.numeric(Decile)==1, {lapply(.SD, function(x) sum(x*Weight)/sum(G13*Weight))}][]
