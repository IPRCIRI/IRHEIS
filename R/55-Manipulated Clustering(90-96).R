...
dt2Urban<-dt2Urban[NewArea2=="Gilan" | NewArea2=="Alborz" |
                     ...
                     NewArea2=="Markazi"   |  NewArea2=="Esfahan" |
                     NewArea2=="Ghom" |  NewArea2=="Sh_Arak" |
                      NewArea2=="Tehran" |  NewArea2=="Sh_Tabriz" |
                     NewArea2=="Mazandaran"  | NewArea2=="Sh_Yazd" ,
                   cluster3:=3]

dt2Urban<-dt2Urban[  NewArea2=="Yazd" |
                     NewArea2=="Sh_Kerman" |
                        NewArea2=="Sh_Hamedan" |
...
dt2Rural<-dt2Rural[ NewArea2=="Ghazvin" | NewArea2=="Yazd"  |
                       NewArea2=="Gilan" |
                       NewArea2=="Kohkilooye" | NewArea2=="Booshehr",
                   cluster3:=3]

dt2Rural<-dt2Rural[ NewArea2=="Zanjan" |
