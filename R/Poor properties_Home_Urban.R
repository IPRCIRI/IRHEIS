...
##### Hoese Conditions #####
Area_Per<-CBN_NonPoor_Urban[,Area_Per1:=weighted.mean(Area/Dimension,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Area_Per<-CBNPoor_Urban[,Area_Per2:=weighted.mean(Area/Dimension,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Area_Per<-CBN_Urban[,Area_Per:=weighted.mean(Area/Dimension,Weight),by=Poor11][order(Poor11)]
...
Rooms_Per<-CBN_NonPoor_Urban[,Rooms_Per1:=weighted.mean(Rooms/Dimension,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Rooms_Per<-CBNPoor_Urban[,Rooms_Per2:=weighted.mean(Rooms/Dimension,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Rooms_Per<-CBN_Urban[,Rooms_Per:=weighted.mean(Rooms/Dimension,Weight),by=Poor11][order(Poor11)]
...
MetrPrice<-CBN_NonPoor_Urban[,MetrPrice1:=weighted.mean(MetrPrice,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
MetrPrice<-CBNPoor_Urban[,MetrPrice2:=weighted.mean(MetrPrice,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
MetrPrice<-CBN_Urban[,MetrPrice:=weighted.mean(MetrPrice,Weight),by=Poor11][order(Poor11)]
...
##### Electricity #####
Electricity<-CBN_NonPoor_Urban[,Electricity_Poors:=weighted.mean(Electricity,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Electricity<-CBNPoor_Urban[,Electricity:=weighted.mean(Electricity,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Electricity<-CBN_Urban[,Electricity:=weighted.mean(Electricity,Weight),by=Poor11][order(Poor11)]
...
##### PipedWater #####
PipedWater<-CBN_NonPoor_Urban[,PipedWater_Poors:=weighted.mean(PipedWater,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
PipedWater<-CBNPoor_Urban[,PipedWater:=weighted.mean(PipedWater,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
PipedWater<-CBN_Urban[,PipedWater:=weighted.mean(PipedWater,Weight),by=Poor11][order(Poor11)]
...
##### PipedGas #####
PipedGas<-CBN_NonPoor_Urban[,PipedGas_Poors:=weighted.mean(PipedGas,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
PipedGas<-CBNPoor_Urban[,PipedGas:=weighted.mean(PipedGas,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
PipedGas<-CBN_Urban[,PipedGas:=weighted.mean(PipedGas,Weight),by=Poor11][order(Poor11)]
...
##### Telephone #####
Telephone<-CBN_NonPoor_Urban[,Telephone_Poors:=weighted.mean(Telephone,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Telephone<-CBNPoor_Urban[,Telephone:=weighted.mean(Telephone,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Telephone<-CBN_Urban[,Telephone:=weighted.mean(Telephone,Weight),by=Poor11][order(Poor11)]
...
##### Internet #####
Internet<-CBN_NonPoor_Urban[,Internet_Poors:=weighted.mean(Internet,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Internet<-CBNPoor_Urban[,Internet:=weighted.mean(Internet,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Internet<-CBN_Urban[,Internet:=weighted.mean(Internet,Weight),by=Poor11][order(Poor11)]
...
##### Car #####
Car<-CBN_NonPoor_Urban[,Car_Poors:=weighted.mean(Car,Weight),by=ProvinceCode2][order(ProvinceCode2)]
Car<-Car[,.(Car_Poors,ProvinceCode2,Weight)]
Car1<-Car[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(ProvinceCode2)]
Car1[,Weight:=NULL]

Car<-CBNPoor_Urban[,Car:=weighted.mean(Car,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Car<-CBN_Urban[,Car:=weighted.mean(Car,Weight),by=Poor11][order(Poor11)]
...
##### PC #####
PC<-CBN_NonPoor_Urban[,PC_Poors:=weighted.mean(PC,Weight),by=ProvinceCode2][order(ProvinceCode2)]
PC<-PC[,.(PC_Poors,ProvinceCode2,Weight)]
PC1<-PC[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(ProvinceCode2)]
PC1[,Weight:=NULL]

PC<-CBNPoor_Urban[,PC:=weighted.mean(PC,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
PC<-CBN_Urban[,PC:=weighted.mean(PC,Weight),by=Poor11][order(Poor11)]
...
##### Cell #####
Cell<-CBN_NonPoor_Urban[,Cell_Poors:=weighted.mean(Cell,Weight),by=ProvinceCode2][order(ProvinceCode2)]
Cell<-Cell[,.(Cell_Poors,ProvinceCode2,Weight)]
Cell1<-Cell[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(ProvinceCode2)]
Cell1[,Weight:=NULL]

Cell<-CBNPoor_Urban[,Cell:=weighted.mean(Cell,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Cell<-CBN_Urban[,Cell:=weighted.mean(Cell,Weight),by=Poor11][order(Poor11)]
