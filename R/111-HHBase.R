...
for(year in (Settings$startyear:Settings$endyear)){
 ...
 HHBase<-merge(HHBase,ShCode,by="HHID",all.x = TRUE)
  ...
  HHBase[ProvinceCode==0,ProvinceName:="Markazi"]
  HHBase[ProvinceCode==1,ProvinceName:="Gilan"]
  HHBase[ProvinceCode==2,ProvinceName:="Mazandaran"]
  HHBase[ProvinceCode==3,ProvinceName:="Az_Sharghi"]
  HHBase[ProvinceCode==4,ProvinceName:="Az_Gharbi"]
  HHBase[ProvinceCode==5,ProvinceName:="Kermanshah"]
  HHBase[ProvinceCode==6,ProvinceName:="Khoozestan"]
  HHBase[ProvinceCode==7,ProvinceName:="Fars"]
  HHBase[ProvinceCode==8,ProvinceName:="Kerman"]
  HHBase[ProvinceCode==9,ProvinceName:="Khorasan_Razavi"]
  HHBase[ProvinceCode==10,ProvinceName:="Esfahan"]
  HHBase[ProvinceCode==11,ProvinceName:="Sistan"]
  HHBase[ProvinceCode==12,ProvinceName:="Kordestan"]
  HHBase[ProvinceCode==13,ProvinceName:="Hamedan"]
  HHBase[ProvinceCode==14,ProvinceName:="Chaharmahal"]
  HHBase[ProvinceCode==15,ProvinceName:="Lorestan"]
  HHBase[ProvinceCode==16,ProvinceName:="Ilam"]
  HHBase[ProvinceCode==17,ProvinceName:="Kohkilooye"]
  HHBase[ProvinceCode==18,ProvinceName:="Booshehr"]
  HHBase[ProvinceCode==19,ProvinceName:="Zanjan"]
  HHBase[ProvinceCode==20,ProvinceName:="Semnan"]
  HHBase[ProvinceCode==21,ProvinceName:="Yazd"]
  HHBase[ProvinceCode==22,ProvinceName:="Hormozgan"]
  HHBase[ProvinceCode==23,ProvinceName:="Tehran"]
  HHBase[ProvinceCode==24,ProvinceName:="Ardebil"]
  HHBase[ProvinceCode==25,ProvinceName:="Ghom"]
  HHBase[ProvinceCode==26,ProvinceName:="Ghazvin"]
  HHBase[ProvinceCode==27,ProvinceName:="Golestan"]
  HHBase[ProvinceCode==28,ProvinceName:="Khorasan_Shomali"]
  HHBase[ProvinceCode==29,ProvinceName:="Khorasan_Jonoobi"]
  HHBase[ProvinceCode==30,ProvinceName:="Alborz"]
  ...
  HHBase[CountyCode==	0226	,County_Name:="Simorgh"]
  HHBase[CountyCode==	0227	,County_Name:="Savadkooh_N"]
  HHBase[CountyCode==	0228	,County_Name:="Kelardasht"]
  ...
  HHBase[CountyCode==	0625	,County_Name:="Hamidie"]
  HHBase[CountyCode==	0626	,County_Name:="Aghajari"]
  HHBase[CountyCode==	0627	,County_Name:="Karoon"]
  ...
  HHBase[CountyCode==	0939	,County_Name:="Davarzan"]
  ...
  HHBase[CountyCode==	1024	,County_Name:="BooinMiandasht"]
  ...
  HHBase[CountyCode==	1115	,County_Name:="Nimrooz"]
  HHBase[CountyCode==	1116	,County_Name:="Hamoon"]
  HHBase[CountyCode==	1117	,County_Name:="Mirjave"]
  HHBase[CountyCode==	1118	,County_Name:="Ghasreghand"]
  HHBase[CountyCode==	1119	,County_Name:="Fenoj"]
  ...
  HHBase[CountyCode==	1408	,County_Name:="Saman"]
  HHBase[CountyCode==	1409	,County_Name:="Bon"]
  ...
  HHBase[CountyCode==	1511	,County_Name:="Roomshkan"]
  ...
  HHBase[CountyCode==	1708	,County_Name:="Lande"]
  ...
  HHBase[CountyCode==	1810	,County_Name:="Asalooye"]
  ...
  HHBase[CountyCode==	1907	,County_Name:="KhoraHHBaseare"]
  HHBase[CountyCode==	1908	,County_Name:="Tarem"]
  HHBase[CountyCode==	1909	,County_Name:="Mahneshan"]
  HHBase[CountyCode==	1910	,County_Name:="Soltanie"]
  ...
  HHBase[CountyCode==	2006	,County_Name:="Aradan"]
  HHBase[CountyCode==	2007	,County_Name:="Miami"]
  HHBase[CountyCode==	2008	,County_Name:="Sorkhe"]
  ...
  HHBase[CountyCode==	2320	,County_Name:="Pardis"]
  HHBase[CountyCode==	2321	,County_Name:="Gharchak"]
  ...
  HHBase[CountyCode==	2606	,County_Name:="Avoj"]
  ...
  HHBase[CountyCode==	2808	,County_Name:="RazJerglan"]
  ...
  HHBase[CountyCode==	2909	,County_Name:="Zirkooh"]
  HHBase[CountyCode==	2910	,County_Name:="Khosef"]
  HHBase[CountyCode==	2911	,County_Name:="Tabas"]
  ...
  HHBase[CountyCode==	3005	,County_Name:="Eshtehard"]
  HHBase[CountyCode==	3006	,County_Name:="Fardis"]
