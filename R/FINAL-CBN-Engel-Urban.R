...
#CBN[,weighted.mean(Poor3,Weight),by=ProvinceCode][order(ProvinceCode)]
Indexes<-Indexes2[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(ProvinceCode)]
Indexes<-Indexes[,.(ProvinceCode,RealPriceIndex)][order(ProvinceCode)]
CBN[,RealPriceIndex:=NULL]
CBN<-merge(CBN,Indexes,by=c("ProvinceCode"),all.x = TRUE)
CBN<-CBN[,Total_Exp_Month_Per2:=Total_Exp_Month_Per_nondurable*RealPriceIndex]
vvv<-CBN[,.(HHID,RealPriceIndex,ProvinceCode,Total_Exp_Month_Per_nondurable,Total_Exp_Month_Per2)]
...
#utils::View(CBN)
for (col in c("Total_Exp_Month_Per2")) CBN[is.na(get(col)), (col) := Total_Exp_Month_Per_nondurable]
c<-CBN[,.(FoodExpenditure_Per,Total_Exp_Month_Per_nondurable,Total_Exp_Month,Total_Exp_Month_Per2,Poor,Decile,Weight,cluster,ProvinceCode)]
...
CBN[,weighted.mean(Poor4,Weight,na.rm = TRUE),by=cluster][order(cluster)]
CBNPoor3[,weighted.mean(Per_Daily_Calories,Weight,na.rm = TRUE),by=cluster]
...
CBN[,weighted.mean(Poor5,Weight,na.rm = TRUE),by=cluster][order(cluster)]
CBNPoor4[,weighted.mean(Per_Daily_Calories,Weight,na.rm = TRUE),by=cluster]
...
CBN[,weighted.mean(Poor6,Weight,na.rm = TRUE),by=cluster][order(cluster)]
CBNPoor5[,weighted.mean(Per_Daily_Calories,Weight,na.rm = TRUE),by=cluster]
...
CBN[,weighted.mean(Poor7,Weight,na.rm = TRUE),by=cluster][order(cluster)]
CBNPoor6[,weighted.mean(Per_Daily_Calories,Weight,na.rm = TRUE),by=cluster]
...
CBN[,weighted.mean(Poor8,Weight,na.rm = TRUE),by=cluster][order(cluster)]
CBNPoor7[,weighted.mean(Per_Daily_Calories,Weight,na.rm = TRUE),by=cluster]
...
CBN[,weighted.mean(Poor9,Weight,na.rm = TRUE),by=cluster][order(cluster)]
CBNPoor8[,weighted.mean(Per_Daily_Calories,Weight,na.rm = TRUE),by=cluster]
...
CBN[,weighted.mean(Poor10,Weight,na.rm = TRUE),by=cluster][order(cluster)]
CBNPoor9[,weighted.mean(Per_Daily_Calories,Weight,na.rm = TRUE),by=cluster]
