...
Area_Per<-CBN_Poor95[,Area_Per2:=weighted.mean(Area/Dimension,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Area_Per<-CBN95[,Area_Per:=weighted.mean(Area/Dimension,Weight),by=Poor11][order(Poor11)]
...
Rooms_Per<-CBN_Poor95[,Rooms_Per2:=weighted.mean(Rooms/Dimension,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Rooms_Per<-CBN95[,Rooms_Per:=weighted.mean(Rooms/Dimension,Weight),by=Poor11][order(Poor11)]
...
MetrPrice<-CBN_Poor95[,MetrPrice2:=weighted.mean(MetrPrice,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
MetrPrice<-CBN95[,MetrPrice:=weighted.mean(MetrPrice,Weight),by=Poor11][order(Poor11)]
...
Electricity<-CBN95[,Electricity:=weighted.mean(Electricity,Weight),by=Poor11][order(Poor11)]
...
PipedWater<-CBN95[,PipedWater:=weighted.mean(PipedWater,Weight),by=Poor11][order(Poor11)]
...
PipedGas<-CBN95[,PipedGas:=weighted.mean(PipedGas,Weight),by=Poor11][order(Poor11)]
...
Telephone<-CBN95[,Telephone:=weighted.mean(Telephone,Weight),by=Poor11][order(Poor11)]
...
Internet<-CBN95[,Internet:=weighted.mean(Internet,Weight),by=Poor11][order(Poor11)]
...
Car<-CBN95[,Car:=weighted.mean(Car,Weight),by=Poor11][order(Poor11)]
...
PC<-CBN95[,PC:=weighted.mean(PC,Weight),by=Poor11][order(Poor11)]
...
Cell<-CBN95[,Cell:=weighted.mean(Cell,Weight),by=Poor11][order(Poor11)]
