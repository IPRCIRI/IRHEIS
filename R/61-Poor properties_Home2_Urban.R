...
HouseOwn<-CBN_NonPoor_Urban[,HouseOwn_Poors1:=weighted.mean(ifelse(HouseOwn==1,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
HouseOwn<-CBN_NonPoor_Urban[,HouseOwn_Poors2:=weighted.mean(ifelse(HouseOwn==2,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
HouseOwn<-CBN_NonPoor_Urban[,HouseOwn_Poors3:=weighted.mean(ifelse(HouseOwn==3,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
HouseOwn<-CBN_NonPoor_Urban[,HouseOwn_Poors4:=weighted.mean(ifelse(HouseOwn==4,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
HouseOwn<-CBN_NonPoor_Urban[,HouseOwn_Poors5:=weighted.mean(ifelse(HouseOwn==5,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
HouseOwn<-CBN_NonPoor_Urban[,HouseOwn_Poors6:=weighted.mean(ifelse(HouseOwn==6,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
HouseOwn<-CBNPoor_Urban[,HouseOwn_Poors7:=weighted.mean(ifelse(HouseOwn==1,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
HouseOwn<-CBNPoor_Urban[,HouseOwn_Poors8:=weighted.mean(ifelse(HouseOwn==2,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
HouseOwn<-CBNPoor_Urban[,HouseOwn_Poors9:=weighted.mean(ifelse(HouseOwn==3,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
HouseOwn<-CBNPoor_Urban[,HouseOwn_Poors10:=weighted.mean(ifelse(HouseOwn==4,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
HouseOwn<-CBNPoor_Urban[,HouseOwn_Poors11:=weighted.mean(ifelse(HouseOwn==5,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
HouseOwn<-CBNPoor_Urban[,HouseOwn_Poors12:=weighted.mean(ifelse(HouseOwn==6,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
HouseOwn13<-CBN_Urban[,HouseOwn1:=weighted.mean(ifelse(HouseOwn==1,1,0),Weight),by=Poor11][order(Poor11)]
...
HouseOwn14<-CBN_Urban[,HouseOwn2:=weighted.mean(ifelse(HouseOwn==2,1,0),Weight),by=Poor11][order(Poor11)]
...
HouseOwn15<-CBN_Urban[,HouseOwn3:=weighted.mean(ifelse(HouseOwn==3,1,0),Weight),by=Poor11][order(Poor11)]
...
HouseOwn16<-CBN_Urban[,HouseOwn4:=weighted.mean(ifelse(HouseOwn==4,1,0),Weight),by=Poor11][order(Poor11)]
...
HouseOwn17<-CBN_Urban[,HouseOwn5:=weighted.mean(ifelse(HouseOwn==5,1,0),Weight),by=Poor11][order(Poor11)]
...
HouseOwn18<-CBN_Urban[,HouseOwn6:=weighted.mean(ifelse(HouseOwn==6,1,0),Weight),by=Poor11][order(Poor11)]
...
skeleton<-CBN_NonPoor_Urban[,skeleton_Poors1:=weighted.mean(ifelse(skeleton==1,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBN_NonPoor_Urban[,skeleton_Poors2:=weighted.mean(ifelse(skeleton==2,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBN_NonPoor_Urban[,skeleton_Poors3:=weighted.mean(ifelse(skeleton==3,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBN_NonPoor_Urban[,skeleton_Poors4:=weighted.mean(ifelse(skeleton==4,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBN_NonPoor_Urban[,skeleton_Poors5:=weighted.mean(ifelse(skeleton==5,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBN_NonPoor_Urban[,skeleton_Poors6:=weighted.mean(ifelse(skeleton==6,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBN_NonPoor_Urban[,skeleton_Poors13:=weighted.mean(ifelse(skeleton==7,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBN_NonPoor_Urban[,skeleton_Poors14:=weighted.mean(ifelse(skeleton==8,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBN_NonPoor_Urban[,skeleton_Poors15:=weighted.mean(ifelse(skeleton==20,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBN_NonPoor_Urban[,skeleton_Poors16:=weighted.mean(ifelse(skeleton==10,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBNPoor_Urban[,skeleton_Poors7:=weighted.mean(ifelse(skeleton==1,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBNPoor_Urban[,skeleton_Poors8:=weighted.mean(ifelse(skeleton==2,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBNPoor_Urban[,skeleton_Poors9:=weighted.mean(ifelse(skeleton==3,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBNPoor_Urban[,skeleton_Poors10:=weighted.mean(ifelse(skeleton==4,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBNPoor_Urban[,skeleton_Poors11:=weighted.mean(ifelse(skeleton==5,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBNPoor_Urban[,skeleton_Poors12:=weighted.mean(ifelse(skeleton==6,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBNPoor_Urban[,skeleton_Poors17:=weighted.mean(ifelse(skeleton==6,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBNPoor_Urban[,skeleton_Poors18:=weighted.mean(ifelse(skeleton==6,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBNPoor_Urban[,skeleton_Poors19:=weighted.mean(ifelse(skeleton==6,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton<-CBNPoor_Urban[,skeleton_Poors20:=weighted.mean(ifelse(skeleton==6,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
skeleton13<-CBN_Urban[,skeleton1:=weighted.mean(ifelse(skeleton==1,1,0),Weight),by=Poor11][order(Poor11)]
...
skeleton14<-CBN_Urban[,skeleton2:=weighted.mean(ifelse(skeleton==2,1,0),Weight),by=Poor11][order(Poor11)]
...
skeleton15<-CBN_Urban[,skeleton3:=weighted.mean(ifelse(skeleton==3,1,0),Weight),by=Poor11][order(Poor11)]
...
skeleton16<-CBN_Urban[,skeleton4:=weighted.mean(ifelse(skeleton==4,1,0),Weight),by=Poor11][order(Poor11)]
...
skeleton17<-CBN_Urban[,skeleton5:=weighted.mean(ifelse(skeleton==5,1,0),Weight),by=Poor11][order(Poor11)]
...
skeleton18<-CBN_Urban[,skeleton6:=weighted.mean(ifelse(skeleton==6,1,0),Weight),by=Poor11][order(Poor11)]
...
skeleton19<-CBN_Urban[,skeleton7:=weighted.mean(ifelse(skeleton==7,1,0),Weight),by=Poor11][order(Poor11)]
...
skeleton20<-CBN_Urban[,skeleton8:=weighted.mean(ifelse(skeleton==8,1,0),Weight),by=Poor11][order(Poor11)]
...
skeleton21<-CBN_Urban[,skeleton10:=weighted.mean(ifelse(skeleton==10,1,0),Weight),by=Poor11][order(Poor11)]
...
skeleton22<-CBN_Urban[,skeleton20:=weighted.mean(ifelse(skeleton==20,1,0),Weight),by=Poor11][order(Poor11)]
