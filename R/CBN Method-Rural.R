...
#cluster 6
model <- lm(FoodExpenditure_Real~ Total_Exp_Month_Real , weights = Weight, data=CBNPoor7,subset = (cluster==6))
summary(model)
Engel6<-coef(model)[2]
Engel_Reverse6<-1/Engel6
CBNPoor7<-CBNPoor7[,Total_Exp_Month_Per2:=ifelse(cluster==6,Total_Exp_Month_nondurable_Real_Per,Total_Exp_Month_Per2)]
CBNPoorCluster<-CBNPoor7[cluster==6]
Engel6<-weighted.mean(CBNPoorCluster$ratio1,CBNPoorCluster$Weight)
Engel_Reverse6<-1/Engel6
Povertyline6_7<-Engel_Reverse6*weighted.mean(CBNPoorCluster$FoodExpenditure_Per2100,CBNPoorCluster$Weight,na.rm = TRUE)
...
CBN[,Poor8:=ifelse(Total_Exp_Month_Per2 < Povertyline6_7 & cluster==6,1,Poor8)]
c[,Poor8:=ifelse(Total_Exp_Month_Per2 < Povertyline6_7 & cluster==6 ,1,Poor8)]
...
#cluster 6
model <- lm(FoodExpenditure_Real~ Total_Exp_Month_Real , weights = Weight, data=CBNPoor8,subset = (cluster==6))
summary(model)
Engel6<-coef(model)[2]
Engel_Reverse6<-1/Engel6
CBNPoor8<-CBNPoor8[,Total_Exp_Month_Per2:=ifelse(cluster==6,Total_Exp_Month_nondurable_Real_Per,Total_Exp_Month_Per2)]
CBNPoorCluster<-CBNPoor8[cluster==6]
Engel6<-weighted.mean(CBNPoorCluster$ratio1,CBNPoorCluster$Weight)
Engel_Reverse6<-1/Engel6
Povertyline6_8<-Engel_Reverse6*weighted.mean(CBNPoorCluster$FoodExpenditure_Per2100,CBNPoorCluster$Weight,na.rm = TRUE)
...
CBN[,Poor9:=ifelse(Total_Exp_Month_Per2 < Povertyline6_8 & cluster==6,1,Poor9)]
c[,Poor9:=ifelse(Total_Exp_Month_Per2 < Povertyline6_8 & cluster==6 ,1,Poor9)]
...
#cluster 6
model <- lm(FoodExpenditure_Real~ Total_Exp_Month_Real , weights = Weight, data=CBNPoor9,subset = (cluster==6))
summary(model)
Engel6<-coef(model)[2]
Engel_Reverse6<-1/Engel6
CBNPoor9<-CBNPoor9[,Total_Exp_Month_Per2:=ifelse(cluster==6,Total_Exp_Month_nondurable_Real_Per,Total_Exp_Month_Per2)]
CBNPoorCluster<-CBNPoor9[cluster==6]
Engel6<-weighted.mean(CBNPoorCluster$ratio1,CBNPoorCluster$Weight)
Engel_Reverse6<-1/Engel6
Povertyline6_9<-Engel_Reverse6*weighted.mean(CBNPoorCluster$FoodExpenditure_Per2100,CBNPoorCluster$Weight,na.rm = TRUE)
...
CBN[,Poor10:=ifelse(Total_Exp_Month_Per2 < Povertyline6_9 & cluster==6,1,Poor10)]
c[,Poor10:=ifelse(Total_Exp_Month_Per2 < Povertyline6_9 & cluster==6 ,1,Poor10)]
...
#cluster 6
model <- lm(FoodExpenditure_Real~ Total_Exp_Month_Real , weights = Weight, data=CBNPoor10,subset = (cluster==6))
summary(model)
Engel6<-coef(model)[2]
Engel_Reverse6<-1/Engel6
CBNPoor10<-CBNPoor10[,Total_Exp_Month_Per2:=ifelse(cluster==6,Total_Exp_Month_nondurable_Real_Per,Total_Exp_Month_Per2)]
CBNPoorCluster<-CBNPoor10[cluster==6]
Engel6<-weighted.mean(CBNPoorCluster$ratio1,CBNPoorCluster$Weight)
Engel_Reverse6<-1/Engel6
Povertyline6_10<-Engel_Reverse6*weighted.mean(CBNPoorCluster$FoodExpenditure_Per2100,CBNPoorCluster$Weight,na.rm = TRUE)
...
CBN[,Poor11:=ifelse(Total_Exp_Month_Per2 < Povertyline6_10 & cluster==6,1,Poor11)]
c[,Poor11:=ifelse(Total_Exp_Month_Per2 < Povertyline6_10 & cluster==6 ,1,Poor11)]
...
#cluster 6
model <- lm(FoodExpenditure_Real~ Total_Exp_Month_Real , weights = Weight, data=CBNPoor11,subset = (cluster==6))
summary(model)
Engel6<-coef(model)[2]
Engel_Reverse6<-1/Engel6
CBNPoor11<-CBNPoor11[,Total_Exp_Month_Per2:=ifelse(cluster==6,Total_Exp_Month_nondurable_Real_Per,Total_Exp_Month_Per2)]
CBNPoorCluster<-CBNPoor11[cluster==6]
Engel6<-weighted.mean(CBNPoorCluster$ratio1,CBNPoorCluster$Weight)
Engel_Reverse6<-1/Engel6
Povertyline6_11<-Engel_Reverse6*weighted.mean(CBNPoorCluster$FoodExpenditure_Per2100,CBNPoorCluster$Weight,na.rm = TRUE)
...
CBN[,Poor12:=ifelse(Total_Exp_Month_Per2 < Povertyline6_11 & cluster==6,1,Poor12)]
c[,Poor12:=ifelse(Total_Exp_Month_Per2 < Povertyline6_11 & cluster==6 ,1,Poor12)]
...
#cluster 6
model <- lm(FoodExpenditure_Real~ Total_Exp_Month_Real , weights = Weight, data=CBNPoor12,subset = (cluster==6))
summary(model)
Engel6<-coef(model)[2]
Engel_Reverse6<-1/Engel6
CBNPoor12<-CBNPoor12[,Total_Exp_Month_Per2:=ifelse(cluster==6,Total_Exp_Month_nondurable_Real_Per,Total_Exp_Month_Per2)]
CBNPoorCluster<-CBNPoor12[cluster==6]
Engel6<-weighted.mean(CBNPoorCluster$ratio1,CBNPoorCluster$Weight)
Engel_Reverse6<-1/Engel6
Povertyline6_12<-Engel_Reverse6*weighted.mean(CBNPoorCluster$FoodExpenditure_Per2100,CBNPoorCluster$Weight,na.rm = TRUE)
...
CBN[,Poor13:=ifelse(Total_Exp_Month_Per2 < Povertyline6_12 & cluster==6,1,Poor13)]
c[,Poor13:=ifelse(Total_Exp_Month_Per2 < Povertyline6_12 & cluster==6 ,1,Poor13)]
...
#cluster 6
model <- lm(FoodExpenditure_Real~ Total_Exp_Month_Real , weights = Weight, data=CBNPoor13,subset = (cluster==6))
summary(model)
Engel6<-coef(model)[2]
Engel_Reverse6<-1/Engel6
CBNPoor13<-CBNPoor13[,Total_Exp_Month_Per2:=ifelse(cluster==6,Total_Exp_Month_nondurable_Real_Per,Total_Exp_Month_Per2)]
CBNPoorCluster<-CBNPoor13[cluster==6]
Engel6<-weighted.mean(CBNPoorCluster$ratio1,CBNPoorCluster$Weight)
Engel_Reverse6<-1/Engel6
Povertyline6_13<-Engel_Reverse6*weighted.mean(CBNPoorCluster$FoodExpenditure_Per2100,CBNPoorCluster$Weight,na.rm = TRUE)
...
CBN[,Poor14:=ifelse(Total_Exp_Month_Per2 < Povertyline6_13 & cluster==6,1,Poor14)]
c[,Poor14:=ifelse(Total_Exp_Month_Per2 < Povertyline6_13 & cluster==6 ,1,Poor14)]
...
#cluster 6
model <- lm(FoodExpenditure_Real~ Total_Exp_Month_Real , weights = Weight, data=CBNPoor14,subset = (cluster==6))
summary(model)
Engel6<-coef(model)[2]
Engel_Reverse6<-1/Engel6
CBNPoor14<-CBNPoor14[,Total_Exp_Month_Per2:=ifelse(cluster==6,Total_Exp_Month_nondurable_Real_Per,Total_Exp_Month_Per2)]
CBNPoorCluster<-CBNPoor14[cluster==6]
Engel6<-weighted.mean(CBNPoorCluster$ratio1,CBNPoorCluster$Weight)
Engel_Reverse6<-1/Engel6
Povertyline6_14<-Engel_Reverse6*weighted.mean(CBNPoorCluster$FoodExpenditure_Per2100,CBNPoorCluster$Weight,na.rm = TRUE)
...
CBN[,Poor15:=ifelse(Total_Exp_Month_Per2 < Povertyline6_14 & cluster==6,1,Poor15)]
c[,Poor15:=ifelse(Total_Exp_Month_Per2 < Povertyline6_14 & cluster==6 ,1,Poor15)]
...
#cluster 6
model <- lm(FoodExpenditure_Real~ Total_Exp_Month_Real , weights = Weight, data=CBNPoor15,subset = (cluster==6))
summary(model)
Engel6<-coef(model)[2]
Engel_Reverse6<-1/Engel6
CBNPoor15<-CBNPoor15[,Total_Exp_Month_Per2:=ifelse(cluster==6,Total_Exp_Month_nondurable_Real_Per,Total_Exp_Month_Per2)]
CBNPoorCluster<-CBNPoor15[cluster==6]
Engel6<-weighted.mean(CBNPoorCluster$ratio1,CBNPoorCluster$Weight)
Engel_Reverse6<-1/Engel6
Povertyline6_15<-Engel_Reverse6*weighted.mean(CBNPoorCluster$FoodExpenditure_Per2100,CBNPoorCluster$Weight,na.rm = TRUE)
...
CBN[,Poor16:=ifelse(Total_Exp_Month_Per2 < Povertyline6_15 & cluster==6,1,Poor16)]
c[,Poor16:=ifelse(Total_Exp_Month_Per2 < Povertyline6_15 & cluster==6 ,1,Poor16)]
...
#cluster 6
model <- lm(FoodExpenditure_Real~ Total_Exp_Month_Real , weights = Weight, data=CBNPoor16,subset = (cluster==6))
summary(model)
Engel6<-coef(model)[2]
Engel_Reverse6<-1/Engel6
CBNPoor16<-CBNPoor16[,Total_Exp_Month_Per2:=ifelse(cluster==6,Total_Exp_Month_nondurable_Real_Per,Total_Exp_Month_Per2)]
CBNPoorCluster<-CBNPoor16[cluster==6]
Engel6<-weighted.mean(CBNPoorCluster$ratio1,CBNPoorCluster$Weight)
Engel_Reverse6<-1/Engel6
Povertyline6_16<-Engel_Reverse6*weighted.mean(CBNPoorCluster$FoodExpenditure_Per2100,CBNPoorCluster$Weight,na.rm = TRUE)
...
CBN[,Poor17:=ifelse(Total_Exp_Month_Per2 < Povertyline6_16 & cluster==6,1,Poor17)]
c[,Poor17:=ifelse(Total_Exp_Month_Per2 < Povertyline6_16 & cluster==6 ,1,Poor17)]
