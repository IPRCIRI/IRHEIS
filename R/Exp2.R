...
for(year in (Settings$startyear:Settings$endyear)){
  ...
  X<-Total[HSex=="Female",.(Total_Exp_Month_Per=weighted.mean(Total_Exp_Month_Per,Weight),
  ...
  Y<-Total[HSex=="Female",.(Total_Exp_Month_Per=weighted.mean(Total_Exp_Month,Weight),
