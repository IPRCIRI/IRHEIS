...
##### Age #####
#Calculation
Age<-CBN_NonPoor_Urban[,Age:=weighted.mean(HAge,Weight),by=ProvinceCode2][order(ProvinceCode2)]
Age<-Age[,.(Age,ProvinceCode2,Weight)]
Age1<-Age[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(ProvinceCode2)]
Age1[,Weight:=NULL]

Age<-CBNPoor_Urban[,Poor_Age:=weighted.mean(HAge,Weight),by=ProvinceCode2][order(ProvinceCode2)]
Age<-Age[,.(Poor_Age,ProvinceCode2,Weight)]
Age2<-Age[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(ProvinceCode2)]

Age<-CBN_NonPoor_Urban[,Poor_Age_40:=weighted.mean(ifelse(HAge<=40,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
Age<-Age[,.(Poor_Age_40,ProvinceCode2,Weight)]
Age3<-Age[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(ProvinceCode2)]

Age<-CBN_NonPoor_Urban[,Poor_Age_4050:=weighted.mean(ifelse(HAge>40 & HAge<50,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
Age<-Age[,.(Poor_Age_4050,ProvinceCode2,Weight)]
Age4<-Age[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(ProvinceCode2)]

Age<-CBN_NonPoor_Urban[,Poor_Age_50:=weighted.mean(ifelse(HAge>=50,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Age<-CBNPoor_Urban[,Poor_Age_40:=weighted.mean(ifelse(HAge<=40,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
Age<-Age[,.(Poor_Age_40,ProvinceCode2,Weight)]
Age6<-Age[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(ProvinceCode2)]

Age<-CBNPoor_Urban[,Poor_Age_4050:=weighted.mean(ifelse(HAge>40 & HAge<50,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
Age<-Age[,.(Poor_Age_4050,ProvinceCode2,Weight)]
Age7<-Age[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(ProvinceCode2)]

Age<-CBNPoor_Urban[,Poor_Age_50:=weighted.mean(ifelse(HAge>=50,1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
Age<-Age[,.(Poor_Age_50,ProvinceCode2,Weight)]
...
AgeT[,Weight:=NULL]
write.xlsx(AgeT, "D:/R/Poors_Urban.xlsx",sheetName = "Age1")
...
AgeT[,Weight:=NULL]
write.xlsx(AgeT, "D:/R/Poors_Urban.xlsx",sheetName = "Age2",append = TRUE)
...
##### Sex #####
Female<-CBN_NonPoor_Urban[,Female_Poors:=weighted.mean(ifelse(HSex %in% "Female",1,0),Weight),by=ProvinceCode][order(ProvinceCode)]
...
Female<-CBNPoor_Urban[,Female:=weighted.mean(ifelse(HSex %in% "Female",1,0),Weight),by=ProvinceCode][order(ProvinceCode)]
...
Female1[,Weight:=NULL]
write.xlsx(Female1, "D:/R/Poors_Urban.xlsx",sheetName = "Female1",append = TRUE)
...
Female3[,Weight:=NULL]
write.xlsx(Female3, "D:/R/Poors_Urban.xlsx",sheetName = "Female2",append = TRUE)

##### Size #####
Size<-CBN_NonPoor_Urban[,Size:=weighted.mean(Size,Weight),by=ProvinceCode2][order(ProvinceCode2)]
Size<-Size[,.(Size,ProvinceCode2,Weight)]
Size1<-Size[,lapply(.SD,weighted.mean,w=Weight,na.rm = TRUE),by=.(ProvinceCode2)]
Size1[,Weight:=NULL]

Size<-CBNPoor_Urban[,Poor_Size:=weighted.mean(Size,Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
SizeT[,Weight:=NULL]
write.xlsx(SizeT, "D:/R/Poors_Urban.xlsx",sheetName = "Size1",append = TRUE)
...
Size3[,Weight:=NULL]
write.xlsx(Size3, "D:/R/Poors_Urban.xlsx",sheetName = "Size2",append = TRUE)
...
##### Literature #####
Literate<-CBN_NonPoor_Urban[,Literate_Poors:=weighted.mean(ifelse(HLiterate %in% "TRUE",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Literate<-CBNPoor_Urban[,Literate:=weighted.mean(ifelse(HLiterate %in% "TRUE",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Literate1[,Weight:=NULL]
write.xlsx(Literate1, "D:/R/Poors_Urban.xlsx",sheetName = "Literate1",append = TRUE)
...
write.xlsx(Literate3, "D:/R/Poors_Urban.xlsx",sheetName = "Literate2",append = TRUE)
...
Education<-CBN_NonPoor_Urban[,Education_Poors1:=weighted.mean(ifelse(HEduLevel0 %in% "Illiterate",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN_NonPoor_Urban[,Education_Poors2:=weighted.mean(ifelse(HEduLevel0 %in% "Elementary",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN_NonPoor_Urban[,Education_Poors3:=weighted.mean(ifelse(HEduLevel0 %in% "Middle",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN_NonPoor_Urban[,Education_Poors4:=weighted.mean(ifelse(HEduLevel0 %in% "High",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN_NonPoor_Urban[,Education_Poors5:=weighted.mean(ifelse(HEduLevel0 %in% "Pre",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBN_NonPoor_Urban[,Education_Poors6:=weighted.mean(ifelse(HEduLevel0 %in% "University",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBNPoor_Urban[,Education_Poors7:=weighted.mean(ifelse(HEduLevel0 %in% "Illiterate",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBNPoor_Urban[,Education_Poors8:=weighted.mean(ifelse(HEduLevel0 %in% "Elementary",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBNPoor_Urban[,Education_Poors9:=weighted.mean(ifelse(HEduLevel0 %in% "Middle",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBNPoor_Urban[,Education_Poors10:=weighted.mean(ifelse(HEduLevel0 %in% "High",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBNPoor_Urban[,Education_Poors11:=weighted.mean(ifelse(HEduLevel0 %in% "Pre",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education<-CBNPoor_Urban[,Education_Poors12:=weighted.mean(ifelse(HEduLevel0 %in% "University",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Education1[,Weight:=NULL]
write.xlsx(Education1, "D:/R/Poors_Urban.xlsx",sheetName = "Education1",append = TRUE)
...
write.xlsx(Education2, "D:/R/Poors_Urban.xlsx",sheetName = "Education2",append = TRUE)



##### Activity #####
Activity<-CBN_NonPoor_Urban[,Activity_Poors1:=weighted.mean(ifelse(HActivityState %in% "Employed",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN_NonPoor_Urban[,Activity_Poors2:=weighted.mean(ifelse(HActivityState %in% "Unemployed",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN_NonPoor_Urban[,Activity_Poors3:=weighted.mean(ifelse(HActivityState %in% "Income without Work",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN_NonPoor_Urban[,Activity_Poors4:=weighted.mean(ifelse(HActivityState %in% "Student",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN_NonPoor_Urban[,Activity_Poors5:=weighted.mean(ifelse(HActivityState %in% "Housekeeper",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBN_NonPoor_Urban[,Activity_Poors6:=weighted.mean(ifelse(HActivityState %in% "Other",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBNPoor_Urban[,Activity_Poors7:=weighted.mean(ifelse(HActivityState %in% "Employed",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBNPoor_Urban[,Activity_Poors8:=weighted.mean(ifelse(HActivityState %in% "Unemployed",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBNPoor_Urban[,Activity_Poors9:=weighted.mean(ifelse(HActivityState %in% "Income without Work",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBNPoor_Urban[,Activity_Poors10:=weighted.mean(ifelse(HActivityState %in% "Student",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBNPoor_Urban[,Activity_Poors11:=weighted.mean(ifelse(HActivityState %in% "Housekeeper",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity<-CBNPoor_Urban[,Activity_Poors12:=weighted.mean(ifelse(HActivityState %in% "Other",1,0),Weight),by=ProvinceCode2][order(ProvinceCode2)]
...
Activity1[,Weight:=NULL]
write.xlsx(Activity1, "D:/R/Poors_Urban.xlsx",sheetName = "Activity1",append = TRUE)
...
write.xlsx(Activity2, "D:/R/Poors_Urban.xlsx",sheetName = "Activity2",append = TRUE)
